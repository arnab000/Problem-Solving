...
int main()
{
 ...
 while(test--)
 {
     ...
     for(ll i=0;i<n;i++)
     {
         ...
         {
             if(sura[i]!=ans[i-1] && ans[0]!=sura[i])
             ans.push_back(sura[i]);
             else if(mura[i]!=ans[i-1] && ans[0]!=mura[i])
             ans.push_back(mura[i]);
             else if(dura[i]!=ans[i-1] && dura[i]!=ans[0])
             ans.push_back(dura[i]);
         }
