    ...
    ll fro[m+2];
     ...
     for(ll i=0;i<m;i++)
     {
       ...
       ll ans;
         for(ll j=0;j<q;j++)
         {
           if(cnt1[sura[cha[i].second][j]]<=mn)
           {
               if(mn==cnt1[sura[cha[i].second][j]])
               {
                   if(cnt3[ans]>cnt3[sura[cha[i].second][j]])
                   ans=sura[cha[i].second][j];
               ...
               mn=cnt1[sura[cha[i].second][j]];
           }
         }

       fro[cha[i].second]=ans;
         cnt1[ans]++;
         if(cnt1[ans]>(m+1)/2)
         {
             hbe=false;
